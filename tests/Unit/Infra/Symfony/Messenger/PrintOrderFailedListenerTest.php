...
final class PrintOrderFailedListenerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->listener = new PrintOrderFailedListener($this->printJobs, $this->logger);
    }

    public function testPermanentFailureLogsErrorWithOrderNumberAndReleasesTheJob(): void
    {
        ...
        $this->printJobs->expects(self::once())->method('finish')->with('10556');
    ...
    public function testRetriableFailureOnlyWarnsAndKeepsTheJob(): void
    {
        ...
        $this->printJobs->expects(self::never())->method('finish');
